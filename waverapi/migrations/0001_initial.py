    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gear', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='gear_reviews', to='waverapi.gear')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('gear', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='waverapi.gear')),
                ('specifications', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='gear_specs', to='waverapi.specification')),
            ],
        ),
        migrations.AddField(
            model_name='gear',
            name='gear_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='waverapi.geartype'),
        ),
        migrations.AddField(
            model_name='gear',
            name='manufacturer',
        ...
        migrations.AddField(
            model_name='gear',
            name='specifications',
            field=models.ManyToManyField(through='waverapi.GearSpec', to='waverapi.specification'),
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
