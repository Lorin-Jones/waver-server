# Generated by Django 4.1.3 on 2022-12-20 23:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manufacturer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='manufacturer', to='waverapi.manufacturer')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
        ...
        migrations.AddField(
            model_name='gear',
            name='reviews',
            field=models.ManyToManyField(through='waverapi.GearReview', to='waverapi.review'),
        ),
        migrations.AddField(
            model_name='gear',
            name='specifications',
